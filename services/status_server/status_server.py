...
class MainHandler(tornado.web.RequestHandler):
    def get(self):
        ...
        self.write(f"<p>Sysadmins can run <code>make monitor</code> on the server to see how that is progressing.")
        self.write(f"<p>System logs are in <code>./log/app_*.log</code></p>")
